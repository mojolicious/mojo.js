...
export default class App {
  ...
  schema (schema) {
    if (typeof schema === 'string') return this.validator.getSchema(schema);
    return (schema.$id === undefined ? false : this.validator.getSchema(schema.$id)) || this.validator.compile(schema);
  }
