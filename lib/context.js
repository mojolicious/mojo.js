...
export default class Context extends EventEmitter {
  ...
  /** @returns {Client} HTTP/WebSocket client. */
  get client () {
    return this.app.client;
  }

  /** @returns {Object} Plain object containing the application config. */
  get config () {
    return this.app.config;
  }

  /** @returns {File} Application home directory. */
  get home () {
  ...
  /** @returns {Object} Plain object containing user defined models. */
  get models () {
