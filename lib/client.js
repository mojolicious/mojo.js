...
/** Class representing an HTTP/WebSocket client. */
export default class Client extends EventEmitter {
  ...
  constructor (options = {}) {
    ...
    /** @type {string} - Base URL to use for all relative request URLs. */
    this.baseURL = options.baseURL;
    /** @type {tough.CookieJar} - Cookie jar. */
    this.cookieJar = new tough.CookieJar();
    /** @type {number} - Maximum number of redirects to follow. */
    this.maxRedirects = options.maxRedirects ?? 0;
    /** @type {string} - Value for `User-Agent` header. */
   ...
   * @param {object} [options] - Optional request config values.
   * @param {http.Agent} [options.agent]
   * @param {string} [options.auth]
   * @param {string|Buffer|Stream.Readable} [options.body]
   * @param {object} [options.form]
   * @param {object} [options.formData]
   * @param {object} [options.headers]
   * @param {object|Array|string|number|true|false|null} [options.json]
  ...
  /**
   * Perform HTTP request or establish WebSocket connection.
   * @param {object} config - Request config.
   * @param {http.Agent} [config.agent]
   * @param {string} [config.auth]
   * @param {string|Buffer|Stream.Readable} [config.body]
   * @param {object} [config.form]
   * @param {object} [config.formData]
   * @param {object} [config.headers]
   * @param {object|Array|string|number|true|false|null} [config.json]
   * @param {string} [config.method]
   * @param {string[]} [config.protocols]
   * @param {object} [config.query]
   * @param {string|URL} config.url
   * @param {boolean} [config.websocket]
   * @return {Promise<Response|WebSocket>} - Response or WebSocket object.
   */
   ...
   * @param {object} [options.query]
   * @return {Promise<WebSocket>} - WebSocket object.
   */
  ...
  _filterConfig (config) {
    ...
    // Body
    if (config.websocket !== true && config.json !== undefined) {
