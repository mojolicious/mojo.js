...
export default class Client extends EventEmitter {
  ...
  delete (...args) {
    return this._request(this._config('DELETE', ...args));
  }
  ...
  head (...args) {
    return this._request(this._config('HEAD', ...args));
  }

  options (...args) {
    return this._request(this._config('OPTIONS', ...args));
  }

  patch (...args) {
    return this._request(this._config('PATCH', ...args));
  }
  ...
  put (...args) {
    return this._request(this._config('PUT', ...args));
  }
