...
async function captureOutput (options, fn) {
...
async function cliCreateDir (path) {
...
async function cliCreateFile (path, template, values = {}, options = {}) {
...
async function exceptionContext (error, options = {}) {
...
async function loadModules (dirs) {
  const modules = {};
